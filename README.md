This was the shared course repository for analyzing the LMU replication study of Stellar et al. (2018), done in summer 2026 as part of the [CREP project](https://www.crep-psych.org), which was adapted by Malena Sturm.
The main differences lie in the files: `manuscript/manuscript.qmd`, `manuscript/bibliography.bib`, `4-exploratory_analyses.R`
...
This repository was created by [Malena Sturm], the initial repository was created by [Felix Schönbrodt](https://nicebread.de).
